...
public class SouthKorea implements WesternCalendar, ChineseNewYearCalendar {
    ...
    @Override
    public String chineseNewYearLabel() {
        return "Korean New Year's Day";
    }

    @Override
    public boolean includeChineseNewYearEve() {
        return true;
    }

    @Override
    public String chineseNewYearEveLabel() {
        return "Korean New Year's Day";
    }

    @Override
    public boolean includeChineseSecondDay() {
        return true;
    }

    @Override
    public String chineseSecondDayLabel() {
        return "Korean New Year's Day";
    }

    @Override
    public boolean shiftSundayHolidays() {
        return true;
    }
